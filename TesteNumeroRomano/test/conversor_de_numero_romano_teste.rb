...
class ConversorDeNumeroRomanoTeste < Test::Unit::TestCase
	def teste_deve_entender_o_simbolo_I	
		romano =ConversorDeNumeroRomano.new
		numero = romano.converte 'I'
		assert_equal 1, numero
	end
	def teste_deve_entender_dois_simbolos_com_II
		romano= ConversorDeNumeroRomano.new
		numero=romano.converte'II'
		assert_equal 2 , numero
		
	end
	def teste_deve_entender_quatro_simbolos_dois_a_dois_com_XXII
		romano=ConversorDeNumeroRomano.new
		numero= romano.converte'XXII'
		assert_equal 22,numero
	end
	def teste_deve_entender_numero_com_IX
		romano= ConversorDeNumeroRomano.new
